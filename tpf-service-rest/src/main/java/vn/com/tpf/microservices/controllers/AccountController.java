...
public class AccountController {
  ...
  final static String appId = "service_authorization";

  @Autowired
  private RabbitMQService rabbitMQService;

  @GetMapping("/v1/account")
  @PreAuthorize("#oauth2.hasAnyScope('authorization_trust','authorization_write','authorization_read') and hasAnyAuthority('role_root','role_admin')")
  ...
  @PreAuthorize("#oauth2.hasAnyScope('authorization_trust','authorization_write') and hasAnyAuthority('role_root','role_admin')")
  ...
  @PreAuthorize("#oauth2.hasAnyScope('authorization_trust') and hasAnyAuthority('role_root')")
