 ...
 *         &lt;element name="registrationDetails" type="{http://schema.applicationservices.ws.pro.finnone.nucleus.com}registrationDetails" minOccurs="0"/>
 *         &lt;element name="ownershipDetails" type="{http://schema.applicationservices.ws.pro.finnone.nucleus.com}ownershipDetails" maxOccurs="10"/>
...
public class PropertyDetail {
    ...
    @XmlElement(required = true)
    protected List<OwnershipDetails> ownershipDetails;
     ...
     * This is why there is not a <CODE>set</CODE> method for the ownershipDetails property.
     * 
     * <p>
    ...
    public List<OwnershipDetails> getOwnershipDetails() {
        if (ownershipDetails == null) {
            ownershipDetails = new ArrayList<OwnershipDetails>();
        }
