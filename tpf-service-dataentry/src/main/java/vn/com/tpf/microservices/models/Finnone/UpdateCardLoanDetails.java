...
/**
 * <p>Java class for updateCardLoanDetails complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="updateCardLoanDetails">
 *   &lt;complexContent>
 ...
 *         &lt;element name="cardDetails" type="{http://schema.applicationservices.ws.pro.finnone.nucleus.com}updateCardDetails" maxOccurs="4" minOccurs="0"/>
...
@XmlType(name = "updateCardLoanDetails", propOrder = {
    "cardSourcingDetails",
    "cardDetails",
    "pricingCode",
    "surrogateCode",
...
public class UpdateCardLoanDetails {

    @XmlElement(required = true)
    protected CardSourcingDetails cardSourcingDetails;
    protected List<UpdateCardDetails> cardDetails;
     ...
     * {@link UpdateCardDetails }
     * 
     * 
     */
    public List<UpdateCardDetails> getCardDetails() {
        if (cardDetails == null) {
            cardDetails = new ArrayList<UpdateCardDetails>();
        }
