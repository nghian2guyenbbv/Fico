...
public class SearchFileController {
	...
	@PreAuthorize("#oauth2.hasAnyScope('tpf-service-search-file','tpf-service-root','tpf-service-momo','3p-service-momo')")
	public ResponseEntity<?> create(@RequestHeader("Authorization") String token, @RequestBody JsonNode body)
		...
		JsonNode response = rabbitMQService.sendAndReceive("tpf-service-search-file", request);
