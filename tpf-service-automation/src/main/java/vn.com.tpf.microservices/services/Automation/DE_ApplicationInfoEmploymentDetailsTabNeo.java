...
@Getter
public class DE_ApplicationInfoEmploymentDetailsTabNeo {
    ...
    @FindBy(how = How.ID, using = "natureOfBusiness_chosen")
    @CacheLookup
    private WebElement natureOfBusinessElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'natureOfBusiness_chosen_o_')]")
    @CacheLookup
    private List<WebElement> natureOfBusinessOptionElement;

    @FindBy(how = How.ID, using = "EmpTypeId_chosen")
    @CacheLookup
    private WebElement employmentTypeElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'EmpTypeId_chosen_o_')]")
    @CacheLookup
    ...
    @FindBy(how = How.ID, using = "Text_industrySalaried")
    @CacheLookup
    private WebElement industryElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'listitem_industrySalaried0')]")
    @CacheLookup
    ...
    @FindBy(how = How.ID, using = "EmpStatId_chosen")
    @CacheLookup
    private WebElement employmentStatusElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'EmpStatId_chosen_o_')]")
    @CacheLookup
    ...
    @FindBy(how = How.ID, using = "totalYearsInOccupationId_chosen")
    private WebElement totalYearsInOccupationIdElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'totalYearsInOccupationId_chosen_o_')]")
    private List<WebElement> totalYearsInOccupationOptionElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'totalYearsInOccupationId_chosen')]//input")
    private WebElement totalYearsInOccupationInputElement;

    @FindBy(how = How.ID, using = "totalMonthsInOccupationId_chosen")
    private WebElement totalMonthsInOccupationIdElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'totalMonthsInOccupationId_chosen_o_')]")
    private List<WebElement> totalMonthsInOccupationOptionElement;

    @FindBy(how = How.XPATH, using = "//*[contains(@id, 'totalMonthsInOccupationId_chosen')]//input")
    ...
    @FindBy(how = How.ID, using = "MajorChange")
    private WebElement modalMajorChangeElement;

    @FindBy(how = How.XPATH, using = "//a[@onclick='confirmMajorChange(true)']")
    private List<WebElement> btnMajorChangeElement;

    public DE_ApplicationInfoEmploymentDetailsTabNeo(WebDriver driver) {
    ...
    public void setData(EmploymentDTO data) throws JsonParseException, JsonMappingException, IOException, InterruptedException {
        ...
        System.out.println(listOccupationDelete);
        for (WebElement OccupationDeleteButton: listOccupationDelete){
            if (!OccupationDeleteButton.getAttribute("innerHTML").equals("No data available in table")) {
