...
@Getter
public class DE_ApplicationInfoPersonalTabNeo {
    ...
    public DE_ApplicationInfoPersonalTabNeo(WebDriver driver) {
    ...
    public void setValue(ApplicationInfoDTO applicationInfoDTO) throws IOException, InterruptedException {
        ...
        System.out.println(applicationInfoDTO.communicationDetails.getPhoneNumbers());
        System.out.println(applicationInfoDTO.communicationDetails.getPhoneNumbers().get(0).getPhoneNumber());
        System.out.println(" ============");
