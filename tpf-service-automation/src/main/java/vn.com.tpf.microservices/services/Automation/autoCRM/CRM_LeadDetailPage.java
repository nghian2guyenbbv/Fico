...
public class CRM_LeadDetailPage {
    ...
    public void setData(CRM_QuickLeadDTO quickLead, String leadId, String downLoadFileURL) {
        try {
            ...
            for (WebElement element : docNameElement) {
                ...
                if (requiredFiled.contains(docName)) {
                    ...
                    CRM_DocumentsDTO doc=quickLead.documents.stream().filter(q->q.getType().equals(docName)).findAny().orElse(null);
