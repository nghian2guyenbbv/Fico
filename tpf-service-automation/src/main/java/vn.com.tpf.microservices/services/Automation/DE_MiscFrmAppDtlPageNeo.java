...
@Getter
public class DE_MiscFrmAppDtlPageNeo {
...
//------------------------- END UAT --------------------------------
    ...
    @FindBy(how = How.ID, using = "Remark_frmAppDtl_6")
    @CacheLookup
    ...
    //------------------- UPDATE
    @FindBy(how = How.ID, using = "loan_at_work_frmAppDtl_51")
    private WebElement loanOfWorkNoElememt;

    @FindBy(how = How.ID, using = "loan_at_work_frmAppDtl_52")
    ...
    //------------------ UDDATE 19-3-2020-------------------
    @FindBy(how = How.ID, using = "Old_Contract_Loan_Amount_frmAppDtl_51")
    private WebElement oldContractLoanAmountLess20Elememt;

    @FindBy(how = How.ID, using = "Old_Contract_Loan_Amount_frmAppDtl_52")
    private WebElement oldContractLoanAmountMore20Elememt;

    @FindBy(how = How.ID, using = "Old_Contract_Loan_Amount_frmAppDtl_53")
    ...
    public DE_MiscFrmAppDtlPageNeo(WebDriver driver) {
